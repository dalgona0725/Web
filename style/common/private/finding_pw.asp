...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오후 12:03:44">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오후 12:03:44">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오후 12:03:44"></script>
...
<script type="text/javascript">
	...
	<section class="content" style="min-height: 400px;">
		...
		<ul class="tab-type01 mT15">
			<li data-tab="magazine-pm" onclick="javascript:location.href='finding.asp'">아이디찾기</li>
			<li  class="on" data-tab="magazine-interview" onclick="javascript:location.href='finding_pw.asp'">비밀번호 찾기</li>
		</ul>
...
<!-- e:wrap -->
            ...
            <div class="pop_inner">
                ...
                <div class="pop_footer">
                    <div class="pop_btn_group">
                        <a href="/style/common/mypage/myData_chgPassword.asp">비밀번호 변경하기</a>
                    </div>
                </div>
            </div>
        </div>
	...
	<form name="form_ipin" method="post">
		...
		<input type="hidden" name="enc_data" value="">
	...
	$(document).ready(function(){
		...
		$('#btn_danalPop').bind('click',function(evt){
			evt.preventDefault();
			if (pgCheck == 'M') {
				window.open("/style/common/mobilCheck/find_pw/ci_web.asp", "auth_popup", "width=470,height=619,scrollbar=no");  		//모빌리언스
			} else {
				window.open("/style/common/danalCheck/find_pw/ready.asp", "auth_popup", "width=470,height=619,scrollbar=no");		//다날
			}
		});
		//* end
	});
