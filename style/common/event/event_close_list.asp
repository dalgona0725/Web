...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오전 11:55:06">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오전 11:55:06">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오전 11:55:06"></script>
...
<script type="text/javascript">
	...
	<h3 class="sub-title">이벤트<span class="sub">팝콘위드코인에서 다양한 이벤트를 즐기세요.</span></h3>
	<div class="Rtxt">
        <div class="basic_select" style="width:120px;display:inline-block;">
            <label for="area">2021 년도</label>
            <select onchange="getlistData(this.value);" id="area" class="select_option" title="년도">

				   <option value="2021">2021 년도</option>

				   <option value="2020">2020 년도</option>

				   <option value="2019">2019 년도</option>

				   <option value="2018">2018 년도</option>

				   <option value="2017">2017 년도</option>

            </select>
        </div>
    </div>

    <div class="event-box thumBox">
    </div>
	</section>
	<!-- e:content -->
	<!-- s:footer -->
...
<script type="text/javascript">
    function getlistData(sYear){
        $.get('close_list_data.asp?sYear='+sYear, function(data){
            $(".thumBox").empty().html(data);
        });
    }
