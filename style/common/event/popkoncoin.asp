...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오전 11:51:47">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오전 11:51:47">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오전 11:51:47"></script>
...
<style>
	#content{width:1056px;margin:20px auto}
	.link_box{position:relative;height:330px;width:1056px}
	.link_box::before, .link_box::after{display:block;position:absolute;left:50%;transform:translateX(-50%);-webkit-transform:translateX(-50%);-o-transform:translateX(-50%);-ms-transform:translateX(-50%);}
	.link_box::before{content:'';width:2px;height:16px;background:#0055ff;top:27px}
	.link_box::after{content:'팝콘코인이 더 궁금하신가요?';font-size:20px;letter-spacing:-0.05em;line-height:1;color:#5f676d;font-weight:lighter;top:67px}
	.link_box #link{display:block;position:absolute;top:120px;left:50%;background:#0055ff;color:#fff;font-size:24px;font-weight:bold;letter-spacing:-0.08em;height:80px;line-height:80px;padding:0 50px;border-radius:40px;transform:translateX(-50%);box-sizing:border-box}
</style>
</head>
<body>
	<div id="wrapper">
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		<div id="container">
			<div id="content">
				<!-- content -->
				<img src="https://pic.popkontv.com/images/aspw/p-00139/common/popkoncoin/section-01.png" alt="POPKONTV COIN 국내 최초 인터넷 방송 전용 가상화폐인 팝콘코인을 이제 팝콘티비에서 만나보세요!">
				<img src="https://pic.popkontv.com/images/aspw/p-00139/common/popkoncoin/section-02.png" alt="다양한 방송 플랫폼에서 방송으로 코인 보상">
				<img src="https://pic.popkontv.com/images/aspw/p-00139/common/popkoncoin/section-03.png" alt="물론 거래소를 통한 구매와 판매도 가능합니다.">
				<img src="https://pic.popkontv.com/images/aspw/p-00139/common/popkoncoin/section-04.png" alt="사용자끼리 서로 후원도 가능합니다.">
				<img src="https://pic.popkontv.com/images/aspw/p-00139/common/popkoncoin/section-05.png" alt="거래도 OK 환전도 OK">
				<img src="https://pic.popkontv.com/images/aspw/p-00139/common/popkoncoin/section-06.png" alt="2021년 5월 기준 103개의 제휴 파트너, 향후 확대 예정. 국내 103개의 방송 플랫폼에서 사용이 가능합니다.">
			</div>
			<!-- //content -->
			<div class="clear"></div>
		</div>
