...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오전 11:53:57">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오전 11:53:57">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오전 11:53:57"></script>
...
<script type="text/javascript">
	...
	<section class="content snb_content">
		<div class="content-type02">
			<h3 class="sub-title mB25">방송저장 용량 추가<span class="sub">더 많은 녹화방송을 회원들에게 보여줄 수있는 아이템입니다.</span></h3>
			<p class="tit02">방송저장 용량 추가 아이템이란?</p>
			<p class="txt01 mT5">더 많은 녹화방송을 회원들에게 보여줄 수있는 아이템입니다. 기본저장용량 5GB를 30GB로 늘릴 수가 있습니다.</p>
			<div class="gray-box mT15">
				<p class="title">아이템 환불/결제 유의사항</p>
				<ul class="num-list">
                    <li>용량추가 구매 내역확인은 마이페이지에서 확인 할수 있습니다.</li>
                    <li>이용기간이 만료되면 저장된 파일이 전부 삭제됩니다.</li>
			...
			<p class="tit02 mT20">방송저장 용량 추가 아이템 구매하기</p>
			<ul class="item-list2 item_saveUp clfix">
                <li>
                    <a href="#" name="lnk_signAlert" alt="buy">
                        <div class="item_detail">
                            <p class="item-title">추가용량 30GB 구매</p>
                            <p class="item-title2">유효기간: 사용설정 이후 30일간</p>
                            <p class="price">9,900원 (VAT포함)</p>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#" name="lnk_signAlert" alt="gift">
                        <div class="item_detail">
                            <p class="item-title">추가용량 30GB 선물</p>
                            <p class="item-title2">유효기간: 사용설정 이후 30일간</p>
                            <p class="price">9,900원 (VAT포함)</p>
                        </div>
                    </a>
		...
		<div class="snb">
			...
			<ul>
				...
				<li class="on"><a href="/style/common/item/item_saveUp.asp">방송저장용량추가</a></li>
...
<form name="frm" id="frm" method="post" action="">
	<input type="hidden" id="itemCode" name="itemCode" value="AL-0001">
</form>
<script type="text/javascript">
	$(document).ready(function(){
		//* lnk_coin
