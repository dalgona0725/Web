...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오전 11:54:06">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오전 11:54:06">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오전 11:54:06"></script>
...
<script type="text/javascript">
	...
	<section class="content snb_content">
		<div class="content-type02">
			<h3 class="sub-title mB25">프리미엄 닉네임 이용권<span class="sub">특정 닉네임을 독점적으로 사용이 가능한 아이템 입니다.</span></h3>
			<p class="tit02">프리미엄 닉네임 이용권이란?</p>
			<p class="txt01 mT5">특정 닉네임을 독점적으로 사용이 가능한 아이템 입니다.</p>
			<div class="gray-box mT15">
				<p class="title">아이템 환불/결제 유의사항</p>
				<ul class="num-list">
				    <li>프리미엄 닉네임 이용권은 중복되는 닉네임으로 이용 불가합니다.</li>
                    <li>결제한 아이템의 유효기간은 설정한 시점부터 적용 됩니다.</li>
                    <li>아이템의 결제 내역은 마이페이지 > 아이템 이용내역 에서 확인 가능합니다.</li>
                    <li>프리미엄 닉네임 이용권 사용 중인 경우, 일반 닉네임 설정 시 사용 중인 프리미엄 닉네임은 보존되며,프리미엄 닉네임 설정 시 재 적용 됩니다.</li>
                    <li><span class="point">탈퇴 시 프리미엄 닉네임은 자동 해제</span>되며, 재가입할 경우에 적용이 안 됩니다.</li>
                    <li>아이템 이용 중 마이페이지 > 내아이템 > 프리미엄 닉네임 에서 사용하기 시 적용 및 연장됩니다.<br>(유효기간 연장은 최대 24개월이며, 보유한 아이템 기간이 연장하려는 기간 포함 24개월 이하일 시 추가 연장 가능)</li>
			...
			<p class="tit02 mT20">프리미엄 닉네임 이용권 구매하기</p>
			<ul class="item-list4 item_changeNick clfix">
                <li>
                    <a href="#" name="lnk_signAlert" alt="buy" data-item="AM-0001">
                        <div class="item_detail">
                            <p class="item-title">1개월 이용권</p>
                            <p class="item-title2">설정일로부터 1개월간</p>
                            <p class="price">110,000원 (VAT포함)</p>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#" name="lnk_signAlert" alt="buy" data-item="AM-0002">
                        <div class="item_detail">
                            <p class="item-title">3개월 이용권</p>
                            <p class="item-title2">설정일로부터 3개월간</p>
                            <p class="price">220,000원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
				<li>
                    <a href="#" name="lnk_signAlert" alt="buy" data-item="AM-0003">
                        <div class="item_detail">
                            <p class="item-title">6개월 이용권</p>
                            <p class="item-title2">설정일로부터 6개월간</p>
                            <p class="price">330,000원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
				<li>
                    <a href="#" name="lnk_signAlert" alt="buy" data-item="AM-0004">
                        <div class="item_detail">
                            <p class="item-title">12개월 이용권</p>
                            <p class="item-title2">설정일로부터 12개월간</p>
                            <p class="price">660,000원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
			</ul>
		...
		<div class="snb">
			...
			<ul>
				...
				<li class="on"><a href="/style/common/item/item_changeNickname.asp">프리미엄 닉네임 이용권</a></li>
...
<form name="frm" id="frm" method="post" action="">
	<input type="hidden" id="itemCode" name="itemCode" value="AM-0001">
</form>
<script type="text/javascript">
	$(document).ready(function(){
		//* lnk_coin
