...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오전 11:54:31">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오전 11:54:31">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오전 11:54:31"></script>
...
$(document).ready(function(){
    ...
    $('a[name="lnk_item"]').bind('click',function(evt){
        ...
        evt.preventDefault();
        var buyType = $(this).data("buy");
        var itemCD = $(this).data("item");
        $("#itemCode").val(itemCD);

        switch(buyType){
            case 'buy':
                $('#frm').attr('action','/item/Proc/itemBuy.asp');
                break;
            case 'gift':
                $('#frm').attr('action','/item/Proc/itemGift.asp');
                break;
        }
        $('#frm').submit();
...
$(document).ready(function() {
var timeEnterimg;
$(".enter_type button").click(function() {
    var $obj = $(this)
    $(this).hide();
    var src = $(this).prev().prop("src").split("?");
    src = src[0]+"?"+(new Date().getTime())
    $(this).prev().prop("src", src);
    $(".enter_type ul li button").not($(this)).show();
    timeEnterimg = setTimeout(function(){
      $obj.show();
    }, 1500)
})
$(".enter_type li img").click(function() {
    $(this).next('button').show();
    clearTimeout(timeEnterimg);
})
});
</script>
</head>
...
<script type="text/javascript">
	...
	<section class="content snb_content">
		<div class="content-type02">
			<h3 class="sub-title mB25">방송 입장효과<span class="sub">방송 입장 시 특별한 효과로 입장하는 아이템입니다.</span></h3>
			<p class="tit02">방송 입장효과란?</p>
			<p class="txt01 mT5">방송 입장 시 특별한 효과로 입장하는 아이템입니다.방송에 입장하여 특별한 효과로 자신을 멋지게 알려보세요.
			마이페이지 > 내아이템 > 방송입장효과 선택 후 사용하기 시 원하는 입장효과 아이템을 선택/변경 할 수 있습니다.</p>
			<div class="gray-box mT15">
				<p class="title">아이템 환불/결제 유의사항</p>
				<ul class="num-list">
				    <li>본 아이템 사용방법은 <span class="point">마이페이지 > 내 아이템에서 유형 설정 후 사용이 가능</span>합니다.</li>
                    <li>방송 입장효과 아이템은 사용 시점부터 구매하신 기간 만큼 사용이 가능합니다.</li>
                    <li>아이템 이용 및 결제 내역은 마이페이지에서 확인이 가능합니다.</li>
                    <li>본 아이템은 <span class="point">구입 후 4가지 유형을 자유롭게 선택</span>할 수 있습니다.</li>
			...
			<p class="tit02 mT20">방송 입장효과 구매하기</p>
			<ul class="item-list3 item_enter clfix">
			    <li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AQ-0001">
                        <div class="item_detail">
                            <p class="item-title">3일이용권</p>
                            <p class="item-title2">유효기간: 사용설정 이후 3일간</p>
                            <p class="price">33,000원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
				<li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AQ-0002">
                        <div class="item_detail">
                            <p class="item-title">7일이용권</p>
                            <p class="item-title2">유효기간: 사용설정 이후 7일간</p>
                            <p class="price">55,000원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
				<li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AQ-0003">
                        <div class="item_detail">
                            <p class="item-title">15일이용권</p>
                            <p class="item-title2">유효기간: 사용설정 이후 15일간</p>
			...
			<!-- 방송입장효과 -->
            <p class="tit02 mT20">방송 입장 효과</p>
            <div class="enter_type">
                <ul class="clfix">
                    <li><img src="https://pic.popkontv.com/files/enterevt/pc_web_bike.gif?1529399268488" alt="방송 입장효과 자전거"><button class="btn_bike" style="display: block;"></button></li>
                    <li><img src="https://pic.popkontv.com/files/enterevt/pc_web_car.gif?1529399269416" alt="방송 입장효과 자동차"><button class="btn_car" style="display: block;"></button></li>
                    <li><img src="https://pic.popkontv.com/files/enterevt/pc_web_train.gif" alt="방송 입장효과 기차"><button class="btn_train"></button></li>
                    <li><img src="https://pic.popkontv.com/files/enterevt/pc_web_plane.gif" alt="방송 입장효과 비행기"><button class="btn_plane"></button></li>
                </ul>
            </div>
		</div>
		<!-- 방송입장효과 플래시 삽입 -->
		<div class="snb">
			...
			<ul>
				...
				<li class="on"><a href="/style/common/item/item_enter.asp">방송 입장효과</a></li>
		...
		$('a[name="lnk_item"]').bind('click',function(evt){
			...
			switch(buyType){
				case 'buy':
					...
					break;
				case 'gift':
					$('#frm').attr('action','https://stageaspw.popkontv.com/item/Proc/itemGift.asp');
					break;
			}
			$('#frm').submit();
