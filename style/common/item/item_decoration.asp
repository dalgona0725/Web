...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오전 11:54:41">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오전 11:54:41">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오전 11:54:41"></script>
...
<script type="text/javascript">
	...
	<section class="content snb_content">
		<div class="content-type02">
			<h3 class="sub-title mB25">리스트 꾸미기<span class="sub">다른 방송과 차별화된 방송 리스트를 제공해드리는 아이템 입니다.</span></h3>
			<p class="tit02">리스트 꾸미기란?</p>
			<p class="txt01 mT5">리스트 꾸미기 아이템은 방송 시작 시 다른 방송과 차별화된 방송 리스트를 제공해드리는 아이템 입니다.
			이용 기간 동안 ON AIR 일 때 적용 됩니다.마이페이지 > 내아이템 > 리스트꾸미기 선택 후사용하기 시 원하는 꾸미기 아이템을 선택/변경 할 수
			있습니다.</p>
			<div class="gray-box mT15">
				<p class="title">아이템 환불/결제 유의사항</p>
				<ul class="num-list">
				    <li>아이템의 이용과 결제 내역은 마이페이지에서 확인이 가능 합니다.</li>
                    <li>결제한 아이템은 <span class="point">마이페이지 > 내아이템에서 사용하기 설정 후 적용</span> 됩니다.</li>
                    <li>결제한 아이템은 마이페이지 > 내아이템 > 리스트꾸미기에서 미사용한 아이템의 경우 선물이 가능합니다.</li>
			...
			<p class="tit02 mT20">리스트 꾸미기 구매하기</p>
			<ul class="item-list4 item_decoration clfix">
                <li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AO-0001">
                        <div class="item_detail">
                            <p class="item-title">1일 이용권</p>
                            <p class="item-title2">유효기간:사용설정후 1일간</p>
                            <p class="price">33,000원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
				<li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AO-0002">
                        <div class="item_detail">
                            <p class="item-title">7일 이용권</p>
                            <p class="item-title2">유효기간:사용설정후 7일간</p>
                            <p class="price">99,000원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
				<li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AO-0003">
                        <div class="item_detail">
                            <p class="item-title">15일 이용권</p>
                            <p class="item-title2">유효기간:사용설정후 15일간</p>
                            <p class="price">165,000원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
				<li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AO-0004">
                        <div class="item_detail">
                            <p class="item-title">30일 이용권</p>
                            <p class="item-title2">유효기간:사용설정후 30일간</p>
			...
			<!-- 리스트 꾸미기 -->
            <p class="tit02 mT20 mB20">리스트 꾸미기 이미지</p>
            <img src="/style/type2/images/deco-type.jpg" alt="리스트 꾸미기">
            <div class="snb">
				...
				<li class="on"><a href="/style/common/item/item_decoration.asp">리스트 꾸미기</a></li>
