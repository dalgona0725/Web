...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오전 11:53:05">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오전 11:53:05">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오전 11:53:05"></script>
...
<script type="text/javascript">
	...
	<section class="content snb_content">
		<div class="content-type02">
			<h3 class="sub-title mB25">풀방 입장권<span class="sub">시청자 수가 초과된 방송을 시청할 수 있는 아이템입니다.</span></h3>
			<p class="tit02">풀방 입장권이란?</p>
			<p class="txt01 mT5">시청자 수가 초과된 방송을 시청 할 수 있는 아이템입니다. 시청인원이 초과된 상태에서도 기다리지 않고 바로 입장하실 수 있습니다.</p>
			<div class="gray-box mT15">
				...
				<ul class="num-list">
				    ...
				    <li>결제한 아이템은 마이페이지 > 내아이템에서 사용하기 설정 후 적용 됩니다.</li>
                    <li>결제한 아이템은 마이페이지 > 내아이템 > 풀방입장권에서 미사용한 아이템의 경우 선물이 가능합니다.</li>
                    <li>미성년자 가입자는 팝콘 및 유료아이템을 구매할 수 없습니다.</li>
                    <li>법정대리인의 동의 없이 미성년자명의 결제한 아이템은 환불이 가능합니다.</li>
				</ul>
			</div>
			<p class="tit02 mT20">풀방 입장권 구매하기</p>
			<ul class="item-list3 item_fullView clfix">

                <li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AB-0001">
                ...
                <li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AB-0002">
                        <div class="item_detail">
                            <p class="item-title">30일이용권</p>
                            <p class="item-title2">유효기간: 사용설정 이후 30일간</p>
                            <p class="price">3,300원 (VAT포함)</p>
                        </div>
                    </a>
				</li>
				<li>
                    <a href="#" name="lnk_signAlert" data-buy="buy" data-item="AB-0003">
                        <div class="item_detail">
                            <p class="item-title">90일이용권</p>
                            <p class="item-title2">유효기간: 사용설정 이후 90일간</p>
		...
		<div class="snb">
			...
			<ul>
								<li class="on"><a href="/style/common/item/item_fullView.asp">풀방 입장권</a></li>
...
<!-- e:wrap -->
<form name="frm" id="frm" method="post" action="https://stageaspw.popkontv.com/style/common/item/item_payment.asp">
