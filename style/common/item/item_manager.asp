...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오전 11:54:21">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오전 11:54:21">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오전 11:54:21"></script>
...
<script type="text/javascript">
	...
	<section class="content snb_content">
		<div class="content-type02">
			<h3 class="sub-title mB25">매니저 추가<span class="sub">방송 진행 시 더 많은 매니저를 지정할 수 있게 해주는 아이템입니다.</span></h3>
			<p class="tit02">매니저 추가란?</p>
			<p class="txt01 mT5">방송 진행 시 더 많은 매니저를 지정할 수 있게 해주는 아이템입니다.</p>
			<div class="gray-box mT15">
				<p class="title">아이템 환불/결제 유의사항</p>
				<ul class="num-list">
				    <li>아이템의 이용과 결제 내역은 마이페이지에서도 확인이 가능 합니다.</li>
                    <li>결제한 아이템은 마이페이지 > 내아이템에서 사용하기 설정 후 적용 됩니다.</li>
                    <li>결제한 아이템은 마이페이지 > 내아이템에서 미사용한 아이템의 경우 선물이 가능합니다.</li>
                    <li>이용기간이 <span class="point">만료되면 3번째 이후에 지정된 매니저는 자동 해제</span> 됩니다.</li>
			...
			<p class="tit02 mT20">매니저 추가 구매하기</p>
			<ul class="item-list2 item_manager clfix">
                <li>
                    <a href="#" name="lnk_signAlert" alt="buy">
                        <div class="item_detail">
                            <p class="item-title">추가구매 +3UP</p>
                            <p class="item-title2">유효기간 : 설정일 부터 30일간</p>
                            <p class="price">55,000원 (VAT포함)</p>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#" name="lnk_signAlert" alt="gift">
                        <div class="item_detail">
                            <p class="item-title">추가선물 +3UP</p>
                            <p class="item-title2">유효기간 : 설정일 부터 30일간</p>
                            <p class="price">55,000원 (VAT포함)</p>
                        </div>
                    </a>
		...
		<div class="snb">
			...
			<ul>
				...
				<li class="on"><a href="/style/common/item/item_manager.asp">매니저 추가</a></li>
...
<form name="frm" id="frm" method="post" action="">
	<input type="hidden" id="itemCode" name="itemCode" value="AN-0001">
</form>
<script type="text/javascript">
	$(document).ready(function(){
		//* lnk_coin
		$('a[name="lnk_item"]').bind('click',function(evt){
			...
			switch(buyType){
				case 'buy':
					...
					break;
				case 'gift':
					$('#frm').attr('action','https://stageaspw.popkontv.com/style/common/item/item_gift.asp');
					break;
			}
			$('#frm').submit();
		});
