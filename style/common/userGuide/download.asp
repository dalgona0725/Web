...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오후 12:00:20">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오후 12:00:20">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오후 12:00:20"></script>
...
<script type="text/javascript">
	...
	<section class="content snb_content">
		...
		<h3 class="sub-title mB20">다운로드/이용가이드
			<span class="sub">팝콘위드코인 사용법 및 이용가이드입니다.</span>
		</h3>
		<h1 class="userT">PC용 다운로드</h1>
		<div class="gray-box mB20">
			<ul class="mgc_use">
				<h2 class="userTm">STEP 01. <span>설치형 플레이어를 다운로드합니다.</span></h2>
				<li>

					<!-- <a href="" target="_blank"><img src="https://pic.popkontv.com/images/aspw/style/common/userGuide/down_air.png" alt="에어다운"></a> -->
					<a href="https://down.popcast.co.kr/popplayer/download.asp?st=%uD31D%uCF58%uC704%uB4DC%uCF54%uC778&sc=P-00139" target="_blank">
						<img src="https://pic.popkontv.com/images/aspw/style/common/userGuide/btn_down_player_type123.png" alt="프로그램 다운">
					</a>
				</li>
				<br><br>
				<h2 class="userTm">STEP 02.<span> 내 PC에 프로그램을 설치해주세요.</span></h2>
				<br><br>
				<h2 class="userTm">STEP 03. <span> 설치 완료 후, 프로그램을 실행합니다.</span></h2>
			</ul>
		</div>
		<h1 class="userT">모바일용 다운로드</h1>
		<div class="gray-box mB20">
			<h2 class="userTm">기종을 확인 후, 알맞은 응용 프로그램 다운로드를 진행해주세요.</h2>
			<p class="txt-center mT20">

				<a href="javascript:alert('서비스 준비중 입니다.');" ><img src="https://pic.popkontv.com/images/aspw/style/common/userGuide/down_android.png" alt="android" style="display:inline;"></a>
				&nbsp;&nbsp;&nbsp;

				<a href="javascript:alert('서비스 준비중 입니다.');" ><img src="https://pic.popkontv.com/images/aspw/style/common/userGuide/down_iphone.png" alt="iPhone" style="display:inline;"></a>

				&nbsp;&nbsp;&nbsp;

                <!-- 원스토어 -->
                <a href="#"><img src="https://pic.popkontv.com/images/aspw/global/down_onestore.png" alt="원스토어"></a>
		...
		<div class="snb">
			...
			<ul>
                ...
                <li class="on"><a href="/style/common/userGuide/download.asp">다운로드가이드</a></li>
			</ul>
		</div>
	</section>
	<!-- e:content -->
