...
<!-- css -->
<link rel="stylesheet" href="/style/common/css/all.css?2021-06-15 오후 12:00:12">
<link rel="stylesheet" type="text/css" href="/style/type1/assets/css/content.css?2021-06-15 오후 12:00:12">
...
<script type="text/javascript" src="/style/common/js/default.js?2021-06-15 오후 12:00:12"></script>
...
<script type="text/javascript">
	...
	<section class="content">
		...
		<h1 class="userT">모바일 App으로 방송하기</h1>
		<div class="gray-box mB20">
			<ul class="mgc_use">
				<li><img src="https://pic.popkontv.com/images/aspw/style/common/userGuide/mobile_guide1.png">
				<div class="mgc_text">1. 방송 제목을 입력<br>
				2. 비공개 방송 여부를 선택 (선택 시 비밀번호 입력)<br>
				3. 19세 이상 시청 가능 여부를 선택<br>
				4. 최대 시청인원을 선택 (최대1,000명)<br>
				5. 방송화질을 선택 (저화질, 표준, 고화질)<br>
				6. 방송형태를 선택 (일반방송, 유료방송, 팬방송)<br>
				7. 확인 버튼 클릭 시 방송화면으로 이동<br>
				8. 방송시작 버튼을 클릭</div></li>
			</ul>
		</div>
		<div class="snb">
			...
			<ul>
				...
				<li class="on"><a href="/style/common/userGuide/mobile_guide.asp">모바일APP 방송가이드</a></li>
